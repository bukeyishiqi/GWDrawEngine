...
let GroupMemberListJson: [String: Any] = [
    "version": "0",
    "template": [
                        "viewType": "StackView",
                        ...
                        "subViews": [
                           ...
                           ["viewType": "CollectionView",
                            ...
                            "sectionsSuffix":[
                                "0": [
                                    ["identifier": "collection_templates_1","memberHeader": "icon_add.png", "memberName": "添加", "actionType": "showPage", "actionParam": ["pageId": "groupManagerAdd", "groupId": "${groupName}"]],
